...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <Notifications />
        <div class="p-4 space-y-6 bg-white dark:bg-gray-900 rounded-lg">
            <h2 class="text-xl font-bold text-gray-900 dark:text-gray-200">Edit Data Bantuan Sosial</h2>
            ...
            <form @submit.prevent="handleUpdate" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <Input v-model="formUpdate.nama" type="text"
                        class="form-input w-full rounded-md border border-gray-300 bg-white text-gray-900 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100" />
                    <!-- <span v-if="form.errors.nama" class="text-red-500 text-sm">{{ form.errors.nama }}</span> -->
                </div>

                <div>
                    <label class="text-gray-700 dark:text-gray-300">NIK</label>
                    <Input v-model="formUpdate.nik" type="text"
                        class="form-input w-full rounded-md border border-gray-300 bg-white text-gray-900 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100" />
                ...
                <div>
                    ...
                    <Input v-model="formUpdate.tanggal_lahir" type="date"
                        class="form-input w-full rounded-md border border-gray-300 bg-white text-gray-900 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100" />
                </div>

                <div>
                    <label class="text-gray-700 dark:text-gray-300">Jenis Kelamin</label>
                    <select v-model="formUpdate.jenis_kelamin"
                        class="form-select w-full border border-gray-300 rounded-md p-2 bg-white text-gray-900 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100">
                ...
                <div>
                    <label class="text-gray-700 dark:text-gray-300">Status Perkawinan</label>
                    <select v-model="formUpdate.status_perkawinan"
                        class="form-select w-full border border-gray-300 rounded-md p-2 bg-white text-gray-900 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100">
                ...
                <div>
                    <label class="text-gray-700 dark:text-gray-300">Agama</label>
                    <select v-model="formUpdate.agama"
                        class="form-select w-full border border-gray-300 rounded-md p-2 bg-white text-gray-900 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100">
                ...
                <div>
                    <label class="text-gray-700 dark:text-gray-300">Kewarganegaraan</label>
                    <Input v-model="formUpdate.kewarganegaraan" type="text"
                        class="form-input w-full rounded-md border border-gray-300 bg-white text-gray-900 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100" />
                </div>

                <div>
                    <label class="text-gray-700 dark:text-gray-300">Pekerjaan</label>
                    <Input v-model="formUpdate.pekerjaan" type="text"
                        class="form-input w-full rounded-md border border-gray-300 bg-white text-gray-900 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100" />
                </div>

                <div>
                    <label class="text-gray-700 dark:text-gray-300">No HP</label>
                    <Input v-model="formUpdate.no_hp" type="text"
                        class="form-input w-full rounded-md border border-gray-300 bg-white text-gray-900 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100" />
                </div>

                <div>
                    <label class="text-gray-700 dark:text-gray-300">Alamat</label>
                    <textarea v-model="formUpdate.alamat"
                        class="form-textarea w-full border border-gray-300 rounded-md p-2 bg-white text-gray-900 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100"></textarea>
                </div>
